      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text">Jeans Palazzo</p>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" width="100%" height="450" src="{{ asset('assets/images/catalogo/jeans baggy elegante.jpg')}}" alt="">
            <div class="card-body">
              <p class="card-text">Jean Baggy.</p>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" width="100%" height="450" src="{{ asset('assets/images/catalogo/jeans baggy.jpg')}}" alt="">
            <div class="card-body">
              <p class="card-text">Jeans Baggy Casual</p>
            </div>
          </div>
        </div>
...
<footer class="text-body-secondary py-5">
  <div class="container">
    ...
    <p class="mb-1"> &copy 2024 Confecciones LyF SAS</p>
